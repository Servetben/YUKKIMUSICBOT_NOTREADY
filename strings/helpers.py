...
/ig (insta reel url) - ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ ʀᴇᴇʟs ғʀᴏᴍ Iɴsᴛᴀɢʀᴀᴍ
Nᴏᴛᴇ - ᴘᴜʙʟɪᴄ ᴏɴʟʏ !
...
/tagall or /all - Tᴏ ᴛᴀɢ ᴀʟʟ ᴍᴇᴍʙᴇʀs ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ.

/scancel or /tagstop - Tᴏ sᴛᴏᴘ ᴏɴɢᴏɪɴɢ ᴛᴀɢɢɪɴɢ ᴘʀᴏᴄᴇss

example to tag - /all Hello 
"""
...
HELP_13 = """**☠️<u>ᴀʀᴛɪғɪᴄɪᴀʟ ɪɴᴛᴇʟʟɪɢᴇɴᴄᴇ</u>**

/gpt or /ai - ᴛᴏ ᴀsᴋ ᴀɴʏᴛʜɪɴɢ ᴏɴ ᴄʜᴀᴛ ɢᴘᴛ 

ᴇxᴀᴍᴘʟᴇ:  /chatgpt Wʜᴇʀᴇ ɪs TᴀJMᴀʜᴀʟ?. """
...
/imagine  : Get the images regarding to your query
