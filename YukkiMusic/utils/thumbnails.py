...
async def gen_thumb(videoid):
    ...
    try:
        ...
        font1 = ImageFont.truetype("Love/Sofia-Regular.otf", 120)
        font2 = ImageFont.truetype("Love/ShortBaby-Mg2w.ttf", 120)
        font3 = ImageFont.truetype("Love/LTBeverage.otf", 120)
        font4 = ImageFont.truetype("Love/font.ttf", 85)
        draw.text((1820, 740), f"Title: {title[:50]} .", (255, 255, 255), font=font1)
        draw.text((1820, 940), f"Views: {views}", (255, 255, 255), font=font2)
        draw.text((1820, 1140), f"Channel: {channel}", (255, 255, 255), font=font3)
        draw.text((3200, 10), f" hmm ", (255, 105, 180), font=font4)
        try:
