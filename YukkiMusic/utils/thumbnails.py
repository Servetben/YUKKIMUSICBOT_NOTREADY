...
def circle(img):
    ...
    a = Image.new('L', [h,w], 0)
    b = ImageDraw.Draw(a)
    b.pieslice([(0, 0), (h,w)], 0, 360, fill = 255,outline = "green")
    c = np.array(img)
    d = np.array(a)
    e = np.dstack((c, d))
...
def circle2(img,Xcenter,Ycenter):
    ...
    a = Image.new('L', [h,w], 0)
    b = ImageDraw.Draw(a)
    b.pieslice([(0, 0), (h,w)], 0, 360, fill = 255,outline = "pink")
    b.pieslice([(int(Xcenter-50), int(Ycenter-30)), (int(Xcenter+50),int(Ycenter+30))], 0, 360, fill = 0,outline = "yellow")
    c = np.array(img)
    d = np.array(a)
    e = np.dstack((c, d))
    return Image.fromarray(e)
...
def squ(img1):
    ...
    b=ImageDraw.Draw(a)
    b.line((320,0,240,550),fill="blue",width=670)
...
async def gen_thumb(videoid,user_id):
    ...
    try:
        ...
        b.pieslice([(690, 40), (1090,440)], 0, 360,outline = "multicolour",width=10)
        ...
        font2 = ImageFont.truetype("assets/font.ttf",75)
        arial = ImageFont.truetype("assets/font2.ttf", 30)
        name_font = ImageFont.truetype("assets/font.ttf", 30)
        font3=ImageFont.truetype("assets/font.ttf",30)
        font4=ImageFont.truetype("assets/font.ttf",30)
        font5=ImageFont.truetype("assets/font.ttf",40)
