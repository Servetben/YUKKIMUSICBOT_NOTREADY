    ...
    try:
     ...
     #  if not is_selected:
         ...
         try:
            ...
            p1 = "Love/cplshebhai.jpg"
         try:
            p2 = await app.download_media(photo2.big_file_id, file_name="pfp1.png")
         except Exception:
            p2 = "Love/cplshebhai.jpg"
            
         img1 = Image.open(f"{p1}")
         img2 = Image.open(f"{p2}")

         img = Image.open("Love/cplshebhai.jpg")

         img1 = img1.resize((340, 340))
         img2 = img2.resize((340, 340))
         ...
         img.paste(img1, (800, 180), img1)
         img.paste(img2, (940, 300), img2)
