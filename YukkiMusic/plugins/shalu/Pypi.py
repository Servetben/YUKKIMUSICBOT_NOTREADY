...
def pypi_info_command(client, message):
    try:
        ...
        if pypi_info:
            ...
            info_message = f"Pαƙαɠҽ ɳαɱҽ➪ {pypi_info['info']['name']}\n\n" \
                           f"Lαƚҽʂƚ ʋҽɾʂισɳ ➪ {pypi_info['info']['version']}\n\n" \
                           f"Dҽʂƈɾιρƚισɳ➪ {pypi_info['info']['summary']}\n\n" \
                           f"քʀօʝɛƈȶ ʊʀʟ➪ {pypi_info['info']['project_urls']['Homepage']}"
