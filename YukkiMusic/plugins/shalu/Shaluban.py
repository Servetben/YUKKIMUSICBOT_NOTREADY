...
"haa ye krlo pehle",
" i cant do this he is my bestie ",
...
@app.on_message(filters.command(["shalini","shalu"], prefixes=["", "/"]) & admin_filter)
        ...
        for banned in data:
            ...
            if banned in ban:
                if user_id in SUDOERS:
                    ...
                    await message.reply("OK, Ban Successful")
